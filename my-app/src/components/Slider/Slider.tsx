...
//           >
//             <Image
//               className={`${s.icon} ${isLeftButtonHover ? s.iconHover : ''}`}
...
//           >
//             <Image
//               className={`${s.icon} ${isRightButtonHover ? s.iconHover : ''}`}
        ...
        <div className={s.buttonsWrapper}>
          ...
          >
            <div className={s.imageWrapper}>
              <Image
                className={`${s.icon} ${isLeftButtonHover ? s.iconHidden : ''}`}
                src={arrowLeft}
                alt='prev'
              />
              <Image
          ...
          >
            <div className={s.imageWrapper}>
              <Image
                className={`${s.icon} ${isRightButtonHover ? s.iconHidden : ''}`}
                src={arrowLeft}
                alt='next'
              />
              <Image
